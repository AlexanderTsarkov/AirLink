...
- `wip/mvp-0.1-first-slice-selection.md` — is the owner-selected, non-canonical AL-0002 planning record comparing first-slice candidates and selecting the Map Flight Core with early estimated wind, now exercised from a materialized replay stream; it is not implementation authority and remains the selection input to the issue #37 implementation plan.
- `wip/mvp-0.1-first-slice-implementation-plan.md` — is the non-canonical AL-0002 implementation-ready plan for the selected replay-driven Map Flight Core, including runtime boundaries, derivations, recording, independent validation, AL-0003 decomposition, and Draft PR #44 traceability; it does not authorize implementation.
