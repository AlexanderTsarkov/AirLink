...
- Do not begin mobile, web, server, firmware, or infrastructure implementation unless an active implementation iteration and an approved bounded issue explicitly authorize that work.
